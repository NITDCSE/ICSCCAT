...
export const tracks = [
    {
        ...
        content:
            [
                `The track on data analysis and mining serves as a dynamic and information-rich
                forum where professionals, researchers, and experts converge to explore the
                latest developments, challenges, and innovations in the field. The field of data
                analytics and mining is characterized by constant innovation and adaptation to
                emerging technologies and data sources. Key trends include the increasing
                adoption of artificial intelligence and machine learning techniques for more 
                advanced and accurate analysis, the growing importance of real-time analytics
                for timely insights, and the emphasis on data privacy and security in the wake of
                evolving regulations. Additionally, the fusion of data analytics with other
                technologies like the Internet of Things (IoT) and edge computing is opening up
                new possibilities for data-driven insights in various industries. The topics include,
                but are not limited to:`,
            ],
        bullets: ["Data retrieval","Big Data Storage techniques","Data Mining and warehousing","Data visualisation","Modelling structure and storage of data","Scalability and portability issues of data","Data privacy and security","Parallel processing of big data","Distributed access of data","Application of big data and related topics","Web mining, text mining","Sentiment analysis","Novel theoretical and computational models"],
        image: profile,
        id:"dataanalytics"
    },
    {
        ...
        , image: profile,
        id:"cryptography",
        bullets : ["Security and privacy in mobile systems","Security and privacy in adhoc networks","Network performance analysis","Cyber risk and vulnerability assessment","Intrusion detection and prevention","Visual analytics for cyber security","Security and privacy in Grid computing","Biometric security and privacy","Security and privacy in Wireless Sensor networks","Cryptographic aspects of block chains & crypto currencies","Cryptanalysis, Side-channel attacks and defences","Trust Management","Cyber harmony","Vehicle-to- Everything (V2X) Communications","Machine-to-Machine(M2M) Communication"]
