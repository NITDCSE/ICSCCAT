            ...
            <section id="railway" className=" bg-primary10 px-3 py-12  venue">
                <div className="textdiv">
                    ...
                    <div className="px-12">
                        ...
                        <Link href="https://www.nitdelhi.ac.in" className="underline"><h3
                            className="hh">www.nitdelhi.ac.in</h3>
                        </Link>
                    </div>
                </div>
                ...
                <div className="venue card-sec justify-center">
                    <div className="card-c ">
                        <div className="a-box">
                            ...
                            <div className="text-container">
                                <Link
                                    href="https://www.google.co.in/maps/dir/Indira+Gandhi+International+Airport+(DEL),+New+Delhi,+Delhi/R48M%2B8GJ+NIT+mini+campus,+Garthi+Khurad,+Bakoli,+Delhi,+110040,+India/@28.6869704,76.9810009,11z/data=!3m1!4b1!4m14!4m13!1m5!1m1!1s0x390d1b85fc2a2d89:0xbef376182c43ed9d!2m2!1d77.0999578!2d28.5561624!1m5!1m1!1s0x390dab5cd0fb849d:0x7ab58dbc07e97512!2m2!1d77.1337505!2d28.8158275!3e0">
                    ...
                    <div className="card-c ">
                        <div className="a-box">
                            ...
                            <div className="text-container">
                                <Link href="https://goo.gl/maps/FYg9TEDneGg36JZm7"><h3>From New Delhi Railway
                                    Station</h3>
                                </Link>
                                {/* <h3>From Indira Gandhi International Airport</h3> */}
                            </div>
