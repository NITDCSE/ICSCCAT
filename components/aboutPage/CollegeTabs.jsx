    ...
    return (
        <div className="bg-primary20">
            <div className="container mx-auto px-6 flex">
                ...
                <p onClick={setNitdActive(false)} className={`flex-1 text-center py-4 text-xl ${nitdActive ? "": "text-primaryRegular"}`}>Swami Shraddhanand College, University of Delhi</p>
            </div>
        </div>
    )
}